...
namespace AcePokerSolutions.NotesApp.Theme
{
    public static class TreeViewHelper
    {
        ...
        //
        private static TreeViewItem m_currentItem;
        ...
        // The DP itself
        private static readonly DependencyProperty IsMouseDirectlyOverItemProperty =
        ...
        static void OnUpdateOverItem(object sender, RoutedEventArgs args)
        {
            ...
            m_currentItem = sender as TreeViewItem;

            // Tell that item to re-calculate the IsMouseDirectlyOverItem property
            if (m_currentItem != null) m_currentItem.InvalidateProperty(IsMouseDirectlyOverItemProperty);
        ...
        // the MouseLeave event on TreeViewItems.  It updates the currentItem, and updates
        ...
        static void OnMouseTransition(object sender, MouseEventArgs args)
        {
            lock (IsMouseDirectlyOverItemProperty)
            {
                if (m_currentItem != null)
                {
                    ...
                    DependencyObject oldItem = m_currentItem;
                    m_currentItem = null;
                ...
                if (currentPosition != null)
                {
                    ...
                    // in the tree, it will receive this event and update currentItem.
