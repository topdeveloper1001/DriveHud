//-----------------------------------------------------------------------
// <copyright file="XROReg.cs" company="Ace Poker Solutions">
...
{
    internal class XROReg : ILicenseManager
    {
        private readonly XRORegistration.XROReg licenseManager = new XRORegistration.XROReg();
