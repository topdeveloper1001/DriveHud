//-----------------------------------------------------------------------
// <copyright file="PKTReg.cs" company="Ace Poker Solutions">
...
{
    internal class PKTReg : ILicenseManager
    {
        private readonly PKTRegistration.PKTReg licenseManager = new PKTRegistration.PKTReg();
