    ...
    internal class Adda52TableService : BaseImporter, IAdda52TableService
    {
        ...
        private static readonly ReadOnlyDictionary<CashTableKey, string> ringTables = new ReadOnlyDictionary<CashTableKey, string>(
            new Dictionary<CashTableKey, string>
            {
                ...
                [CashTableKey.From(100, 16000, TableTypeDescription.Regular, GameType.PotLimitOmaha, 6)] = "PLO Summer",
                ...
                [CashTableKey.From(200, 32000, TableTypeDescription.Regular, GameType.PotLimitOmaha, 6)] = "PLO Crushers",
                ...
                [CashTableKey.From(600, 60000, TableTypeDescription.Regular, GameType.PotLimitOmaha, 6)] = "PLO Score",
