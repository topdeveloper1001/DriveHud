    ...
    internal class PokerStarsImporter : BaseImporter, IPokerStarsImporter
    {
        ...
        protected override void DoImport()
        {
            ...
            while (!cancellationTokenSource.IsCancellationRequested)
            {
                ...
                {
                    LogProvider.Log.Error(this, "PokerStars auto-import failed", e);
                }
            }
        ...
        protected bool Match(string title, string tableName)
        {
        ...
        private Bovada.GameType ParseGameType(ParsingResult parsingResult)
        {
        ...
        private EnumTableType ParseTableType(ParsingResult parsingResult)
        {
            if (parsingResult.Source == null || parsingResult.Source.GameDescription == null)
            {
