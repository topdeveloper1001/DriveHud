    ...
    public class FilterAdvancedModel : FilterBaseEntity, IFilterModel
    {
        ...
        private static readonly ReadOnlyDictionary<AdvancedFilterType, Func<Playerstatistic, double?, bool>> FiltersActions =
            new ReadOnlyDictionary<AdvancedFilterType, Func<Playerstatistic, double?, bool>>(new Dictionary<AdvancedFilterType, Func<Playerstatistic, double?, bool>>
            {
                ...
                { AdvancedFilterType.BBsBetFlopisBiggerThan, (p, v) => p.BetAmountFlopInBB > v },
                { AdvancedFilterType.BBsBetFlopisLessThan, (p, v) => p.BetAmountFlopInBB < v },
                { AdvancedFilterType.BBsCalledFlopisBiggerThan, (p, v) => p.CallAmountFlopInBB > v },
                { AdvancedFilterType.BBsCalledFlopisLessThan, (p, v) => p.CallAmountFlopInBB < v },
                { AdvancedFilterType.BBsPutinFlopisBiggerThan, (p, v) => p.BetAmountFlopInBB + p.CallAmountFlopInBB > v },
                { AdvancedFilterType.BBsPutinFlopisLessThan, (p, v) => p.BetAmountFlopInBB + p.CallAmountFlopInBB < v },
                { AdvancedFilterType.FlopPotSizeinBBsisBiggerThan, (p, v) => p.FlopPotSizeInBB > v },
                { AdvancedFilterType.FlopPotSizeinBBsisLessThan, (p, v) => p.FlopPotSizeInBB < v },
                { AdvancedFilterType.FlopStackPotRatioisBiggerThan, (p, v) => p.FlopStackPotRatio > v },
                { AdvancedFilterType.FlopStackPotRatioisLessThan, (p, v) => p.FlopStackPotRatio < v },
                { AdvancedFilterType.FlopBetSizePotisBiggerThan, (p, v) => (double)p.FlopBetToPotRatio > v },
                { AdvancedFilterType.FlopBetSizePotisLessThan, (p, v) => (double)p.FlopBetToPotRatio < v },
                { AdvancedFilterType.FlopRaiseSizePotisBiggerThan, (p, v) => p.FlopRaiseSizeToPot > v },
                { AdvancedFilterType.FlopRaiseSizePotisLessThan, (p, v) => p.FlopRaiseSizeToPot < v },
                { AdvancedFilterType.FlopFacingBetSizePotisBiggerThan, (p, v) => p.FlopFacingBetSizeToPot > v },
                { AdvancedFilterType.FlopFacingBetSizePotisLessThan, (p, v) => p.FlopFacingBetSizeToPot < v },
                { AdvancedFilterType.FlopFacingRaiseSizePotisBiggerThan, (p, v) => p.FlopFacingRaiseSizeToPot > v },
                { AdvancedFilterType.FlopFacingRaiseSizePotisLessThan, (p, v) => p.FlopFacingRaiseSizeToPot < v },
                ...
                { AdvancedFilterType.PlayersonTurnisBiggerThan, (p, v) => p.NumberOfPlayersOnTurn > v },
                { AdvancedFilterType.PlayersonTurnisLessThan, (p, v) => p.NumberOfPlayersOnTurn > v },
                { AdvancedFilterType.PlayersonTurnisEqualTo, (p, v) => p.NumberOfPlayersOnTurn == v },
                ...
                { AdvancedFilterType.BBsBetTurnisBiggerThan, (p, v) => p.BetAmountTurnInBB > v },
                { AdvancedFilterType.BBsBetTurnisLessThan, (p, v) => p.BetAmountTurnInBB < v },
                { AdvancedFilterType.BBsCalledTurnisBiggerThan, (p, v) => p.CallAmountTurnInBB > v },
                { AdvancedFilterType.BBsCalledTurnisLessThan, (p, v) => p.CallAmountTurnInBB < v },
                { AdvancedFilterType.BBsPutinTurnisBiggerThan, (p, v) => p.BetAmountTurnInBB + p.CallAmountTurnInBB > v },
                { AdvancedFilterType.BBsPutinTurnisLessThan, (p, v) => p.BetAmountTurnInBB + p.CallAmountTurnInBB < v },
                { AdvancedFilterType.TurnPotSizeinBBsisBiggerThan, (p, v) => p.TurnPotSizeInBB > v },
                { AdvancedFilterType.TurnPotSizeinBBsisLessThan, (p, v) => p.TurnPotSizeInBB < v },
                { AdvancedFilterType.TurnStackPotRatioisBiggerThan, (p, v) => p.TurnStackPotRatio > v },
                { AdvancedFilterType.TurnStackPotRatioisLessThan, (p, v) => p.TurnStackPotRatio < v },
                { AdvancedFilterType.TurnBetSizePotisBiggerThan, (p, v) => (double)p.TurnBetToPotRatio > v },
                { AdvancedFilterType.TurnBetSizePotisLessThan, (p, v) => (double)p.TurnBetToPotRatio < v },
                { AdvancedFilterType.TurnRaiseSizePotisBiggerThan, (p, v) => p.TurnRaiseSizeToPot > v },
                { AdvancedFilterType.TurnRaiseSizePotisLessThan, (p, v) => p.TurnRaiseSizeToPot < v },
                { AdvancedFilterType.TurnFacingBetSizePotisBiggerThan, (p, v) => p.TurnFacingBetSizeToPot > v },
                { AdvancedFilterType.TurnFacingBetSizePotisLessThan, (p, v) => p.TurnFacingBetSizeToPot < v },
                { AdvancedFilterType.TurnFacingRaiseSizePotisBiggerThan, (p, v) => p.TurnFacingRaiseSizeToPot > v },
                { AdvancedFilterType.TurnFacingRaiseSizePotisLessThan, (p, v) => p.TurnFacingRaiseSizeToPot < v },
                ...
                { AdvancedFilterType.PlayersonRiverisBiggerThan, (p, v) => p.NumberOfPlayersOnRiver > v },
                { AdvancedFilterType.PlayersonRiverisLessThan, (p, v) => p.NumberOfPlayersOnRiver > v },
                { AdvancedFilterType.PlayersonRiverisEqualTo, (p, v) => p.NumberOfPlayersOnRiver == v },
                ...
                { AdvancedFilterType.BBsBetRiverisBiggerThan, (p, v) => p.BetAmountRiverInBB > v },
                { AdvancedFilterType.BBsBetRiverisLessThan, (p, v) => p.BetAmountRiverInBB < v },
                { AdvancedFilterType.BBsCalledRiverisBiggerThan, (p, v) => p.CallAmountRiverInBB > v },
                { AdvancedFilterType.BBsCalledRiverisLessThan, (p, v) => p.CallAmountRiverInBB < v },
                { AdvancedFilterType.BBsPutinRiverisBiggerThan, (p, v) => p.BetAmountRiverInBB + p.CallAmountRiverInBB > v },
                { AdvancedFilterType.BBsPutinRiverisLessThan, (p, v) => p.BetAmountRiverInBB + p.CallAmountRiverInBB < v },
                { AdvancedFilterType.RiverPotSizeinBBsisBiggerThan, (p, v) => p.RiverPotSizeInBB > v },
                { AdvancedFilterType.RiverPotSizeinBBsisLessThan, (p, v) => p.RiverPotSizeInBB < v },
                { AdvancedFilterType.RiverStackPotRatioisBiggerThan, (p, v) => p.RiverStackPotRatio > v },
                { AdvancedFilterType.RiverStackPotRatioisLessThan, (p, v) => p.RiverStackPotRatio < v },
                { AdvancedFilterType.RiverBetSizePotisBiggerThan, (p, v) => (double)p.RiverBetToPotRatio > v },
                { AdvancedFilterType.RiverBetSizePotisLessThan, (p, v) => (double)p.RiverBetToPotRatio < v },
                { AdvancedFilterType.RiverRaiseSizePotisBiggerThan, (p, v) => p.RiverRaiseSizeToPot > v },
                { AdvancedFilterType.RiverRaiseSizePotisLessThan, (p, v) => p.RiverRaiseSizeToPot < v },
                { AdvancedFilterType.RiverFacingBetSizePotisBiggerThan, (p, v) => p.RiverFacingBetSizeToPot > v },
                { AdvancedFilterType.RiverFacingBetSizePotisLessThan, (p, v) => p.RiverFacingBetSizeToPot < v },
                { AdvancedFilterType.RiverFacingRaiseSizePotisBiggerThan, (p, v) => p.RiverFacingRaiseSizeToPot > v },
                { AdvancedFilterType.RiverFacingRaiseSizePotisLessThan, (p, v) => p.RiverFacingRaiseSizeToPot < v },
                #endregion

                #region Other
                { AdvancedFilterType.SawShowdown, (p, v) => p.Sawshowdown > 0 },
                { AdvancedFilterType.WonHand, (p, v) => p.Wonhand > 0 },
                { AdvancedFilterType.FinalPotSizeinBBsisBiggerThan, (p, v) => p.PotInBB > v },
                { AdvancedFilterType.FinalPotSizeinBBsisLessThan, (p, v) => p.PotInBB < v },
                { AdvancedFilterType.PlayerWonBBsIsBiggerThan, (p, v) => p.TotalWonInBB > v },
                { AdvancedFilterType.PlayerWonBBsIsLessThan, (p, v) => p.TotalWonInBB < v },
                ...
                { AdvancedFilterType.PlayerWonOrLostBBsIsBiggerThan, (p, v) => Math.Abs(p.TotalWonInBB) > v },
                { AdvancedFilterType.PlayerWonOrLostBBsIsLessThan, (p, v) => Math.Abs(p.TotalWonInBB) < v },
                { AdvancedFilterType.PlayersSawShowdownIsBiggerThan, (p, v) => p.NumberOfPlayersSawShowdown > v },
                { AdvancedFilterType.PlayersSawShowdownIsLessThan, (p, v) => p.NumberOfPlayersSawShowdown < v },
                { AdvancedFilterType.PlayersSawShowdownIsEqualTo, (p, v) => p.NumberOfPlayersSawShowdown == v },
                { AdvancedFilterType.AllinWinIsBiggerThan, (p, v) => (double)p.Equity > v },
                { AdvancedFilterType.AllinWinIsLessThan, (p, v) => (double)p.Equity < v },
                #endregion
