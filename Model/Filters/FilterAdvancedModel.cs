    ...
    public class FilterAdvancedModel : FilterBaseEntity, IFilterModel
    {
        ...
        private static IEnumerable<FilterAdvancedItem> GetFiltersItems()
        {
            return new[]
            {
                ...
                Create(FilterAdvancedStageType.Flop, "Hero Facing Flop Raise", AdvancedFilterType.FlopWasRaised),
                ...
                Create(FilterAdvancedStageType.Turn, "Hero Facing Turn Raise", AdvancedFilterType.TurnWasRaised),
                ...
                Create(FilterAdvancedStageType.River, "Hero Facing River Raise", AdvancedFilterType.RiverWasRaised),
        ...
        private static readonly ReadOnlyDictionary<AdvancedFilterType, Func<Playerstatistic, double?, bool>> FiltersActions =
            new ReadOnlyDictionary<AdvancedFilterType, Func<Playerstatistic, double?, bool>>(new Dictionary<AdvancedFilterType, Func<Playerstatistic, double?, bool>>
            {
                ...
                { AdvancedFilterType.FlopWasBetInto, (p, v) => p.FacedBetOnFlop != 0 },
                { AdvancedFilterType.FlopWasRaised, (p, v) => p.FacedRaiseFlop != 0 },
                ...
                { AdvancedFilterType.TurnWasBetInto, (p, v) => p.FacedBetOnTurn != 0 },
                { AdvancedFilterType.TurnWasRaised, (p, v) => p.FacedRaiseTurn != 0 },
                ...
                { AdvancedFilterType.RiverWasBetInto, (p, v) => p.FacedBetOnRiver != 0 },
                { AdvancedFilterType.RiverWasRaised, (p, v) => p.FacedRaiseRiver != 0 },
