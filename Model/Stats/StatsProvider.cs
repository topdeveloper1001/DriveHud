...
namespace Model.Stats
{
    ...
    public class StatsProvider
    {
        ...
        public static ReadOnlyDictionary<Stat, StatBase> StatsBases = new ReadOnlyDictionary<Stat, StatBase>((new[]
        {
            ...
            new StatBase { Stat = Stat.FoldToCBetSRP, PropertyName = nameof(Indicators.FoldToCBetSRP), CreateStatDto = x => new StatDto(x.FoldToCBetSRP, x.FacingCBetSRP) },
            ...
            new StatBase { Stat = Stat.FoldToDoubleBarrelSRP, PropertyName = nameof(Indicators.FoldToDoubleBarrelSRP), CreateStatDto = x => new StatDto(x.FoldToDoubleBarrelSRP, x.FacingDoubleBarrelSRP) },
            ...
            new StatBase { Stat = Stat.FoldToDoubleBarrel4BetPot, PropertyName = nameof(Indicators.FoldToDoubleBarrel4BetPot), CreateStatDto = x => new StatDto(x.FoldToDoubleBarrel4BetPot, x.FacingDoubleBarrel4BetPot) },
            ...
            new StatBase { Stat = Stat.FoldToTripleBarrelSRP, PropertyName = nameof(Indicators.FoldToTripleBarrelSRP), CreateStatDto = x => new StatDto(x.FoldToTripleBarrelSRP, x.FacingTripleBarrelSRP) },
            new StatBase { Stat = Stat.FoldToTripleBarrel3BetPot, PropertyName = nameof(Indicators.FoldToTripleBarrel3BetPot), CreateStatDto = x => new StatDto(x.FoldToTripleBarrel3BetPot, x.FacingTripleBarrel3BetPot) },
            new StatBase { Stat = Stat.FoldToTripleBarrel4BetPot, PropertyName = nameof(Indicators.FoldToTripleBarrel4BetPot), CreateStatDto = x => new StatDto(x.FoldToTripleBarrel4BetPot, x.FacingTripleBarrel4BetPot) },
        ...
        public static IEnumerable<StatInfo> GetAllStats()
        {
            ...
            var statsCollection = new[]
            {
                ...
                new StatInfo { GroupName = "7", StatInfoGroup = statInfoGroups[6], Stat = Stat.FoldToDoubleBarrelSRP },
                new StatInfo { GroupName = "7", StatInfoGroup = statInfoGroups[6], Stat = Stat.FoldToDoubleBarrelIn3BetPot },
                new StatInfo { GroupName = "7", StatInfoGroup = statInfoGroups[6], Stat = Stat.FoldToDoubleBarrel4BetPot },
                ...
                new StatInfo { GroupName = "8", StatInfoGroup = statInfoGroups[7], Stat = Stat.FoldToTripleBarrelSRP },
                new StatInfo { GroupName = "8", StatInfoGroup = statInfoGroups[7], Stat = Stat.FoldToTripleBarrel3BetPot },
                new StatInfo { GroupName = "8", StatInfoGroup = statInfoGroups[7], Stat = Stat.FoldToTripleBarrel4BetPot },
                ...
                new StatInfo { GroupName = "91", StatInfoGroup = statInfoGroups[9], Stat = Stat.FoldToCBetSRP },
