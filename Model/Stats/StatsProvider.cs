...
namespace Model.Stats
{
    ...
    public class StatsProvider
    {
        ...
        public static ReadOnlyDictionary<Stat, StatBase> StatsBases = new ReadOnlyDictionary<Stat, StatBase>((new[]
        {
            ...
            new StatBase { Stat = Stat.Call3Bet, PropertyName = nameof(Indicators.ThreeBetCall), CreateStatDto = x => new StatDto(x.Calledthreebetpreflop, x.FacedthreebetpreflopVirtual) },
            new StatBase { Stat = Stat.Call3BetIP, PropertyName = nameof(Indicators.Call3BetIP), CreateStatDto = x => new StatDto(x.Call3BetIP, x.Faced3BetIP) },
            new StatBase { Stat = Stat.Call3BetOOP, PropertyName = nameof(Indicators.Call3BetOOP), CreateStatDto = x => new StatDto(x.Call3BetOOP, x.Faced3BetOOP) },
            new StatBase { Stat = Stat.Call3BetEP, PropertyName = nameof(Indicators.Call3BetEP), CreateStatDto = x => new StatDto(x.Call3BetEP, x.Faced3BetEP) },
            new StatBase { Stat = Stat.Call3BetMP, PropertyName = nameof(Indicators.Call3BetMP), CreateStatDto = x => new StatDto(x.Call3BetMP, x.Faced3BetMP) },
            new StatBase { Stat = Stat.Call3BetCO, PropertyName = nameof(Indicators.Call3BetCO), CreateStatDto = x => new StatDto(x.Call3BetCO, x.Faced3BetCO) },
            new StatBase { Stat = Stat.Call3BetBTN, PropertyName = nameof(Indicators.Call3BetBTN), CreateStatDto = x => new StatDto(x.Call3BetBTN, x.Faced3BetBTN) },
            new StatBase { Stat = Stat.Call3BetSB, PropertyName = nameof(Indicators.Call3BetSB), CreateStatDto = x => new StatDto(x.Call3BetSB, x.Faced3BetSB) },
            new StatBase { Stat = Stat.Call4Bet, PropertyName = nameof(Indicators.Call4Bet), CreateStatDto = x => new StatDto(x.Calledfourbetpreflop, x.Facedfourbetpreflop) },
            ...
            new StatBase { Stat = Stat.CalledStealInBB, PropertyName = nameof(Indicators.CalledStealInBB), CreateStatDto = x => new StatDto(x.CalledStealInBB, x.FacedStealInBB) },
            new StatBase { Stat = Stat.CalledBTNStealInSB, PropertyName = nameof(Indicators.CalledBTNStealInSB), CreateStatDto = x => new StatDto(x.CalledBTNStealInSB, x.FacedBTNStealInSB) },
            new StatBase { Stat = Stat.CalledBTNStealInBB, PropertyName = nameof(Indicators.CalledBTNStealInBB), CreateStatDto = x => new StatDto(x.CalledBTNStealInBB, x.FacedBTNStealInBB) },
            new StatBase { Stat = Stat.CalledCOStealInSB, PropertyName = nameof(Indicators.CalledCOStealInSB), CreateStatDto = x => new StatDto(x.CalledCOStealInSB, x.FacedCOStealInSB) },
            new StatBase { Stat = Stat.CalledCOStealInBB, PropertyName = nameof(Indicators.CalledCOStealInBB), CreateStatDto = x => new StatDto(x.CalledCOStealInBB, x.FacedCOStealInBB) },
            ...
            new StatBase { Stat = Stat.CheckRaiseFlopAsPFRInSRP, PropertyName = nameof(Indicators.CheckRaiseFlopAsPFRInSRP), CreateStatDto = x => new StatDto(x.DidCheckRaiseFlopAsPFRInSRP, x.CouldCheckRaiseFlopAsPFRInSRP) },
            new StatBase { Stat = Stat.CheckRaiseFlopAsPFRIn3BetPot, PropertyName = nameof(Indicators.CheckRaiseFlopAsPFRIn3BetPot), CreateStatDto = x => new StatDto(x.DidCheckRaiseFlopAsPFRIn3BetPot, x.CouldCheckRaiseFlopAsPFRIn3BetPot) },
            ...
            new StatBase { Stat = Stat.CheckInStraddle, PropertyName = nameof(Indicators.CheckInStraddle), CreateStatDto = x => new StatDto(x.DidCheckInStraddle, x.CouldActInStraddle)  },
            ...
            new StatBase { Stat = Stat.DelayedTurnCBetInSRP, PropertyName = nameof(Indicators.DelayedTurnCBetInSRP), CreateStatDto = x => new StatDto(x.DidDelayedTurnCBetInSRP, x.CouldDelayedTurnCBetInSRP) },
            new StatBase { Stat = Stat.DelayedTurnCBetIn4BetPot, PropertyName = nameof(Indicators.DelayedTurnCBetIn4BetPot), CreateStatDto = x => new StatDto(x.DidDelayedTurnCBetIn4BetPot, x.CouldDelayedTurnCBetIn4BetPot) },
            ...
            new StatBase { Stat = Stat.DoubleBarrel, PropertyName = nameof(Indicators.DoubleBarrel), CreateStatDto = x => new StatDto(x.DidDoubleBarrel, x.CouldDoubleBarrel) },
            ...
            new StatBase { Stat = Stat.FoldedToDelayedCBet, PropertyName =  nameof(Indicators.FoldedToDelayedCBet), CreateStatDto = x => new StatDto(x.FoldedToDelayedCBet, x.FacedDelayedCBet) },
            ...
            new StatBase { Stat = Stat.FoldToSqueezeAsColdCaller, PropertyName = nameof(Indicators.FoldToSqueezeAsColdCaller), CreateStatDto = x => new StatDto(x.FoldToSqueezeAsColdCaller, x.FacedSqueezeAsColdCaller) },
            new StatBase { Stat = Stat.FoldToStealInSB, PropertyName = nameof(Indicators.FoldToStealInSB), CreateStatDto = x => new StatDto(x.FoldToStealInSB, x.FacedStealInSB) },
            new StatBase { Stat = Stat.FoldToStealInBB, PropertyName = nameof(Indicators.FoldToStealInBB), CreateStatDto = x => new StatDto(x.FoldToStealInBB, x.FacedStealInBB) },
            new StatBase { Stat = Stat.FoldToBTNStealInSB, PropertyName = nameof(Indicators.FoldToBTNStealInSB), CreateStatDto = x => new StatDto(x.FoldToBTNStealInSB, x.FacedBTNStealInSB) },
            new StatBase { Stat = Stat.FoldToBTNStealInBB, PropertyName = nameof(Indicators.FoldToBTNStealInBB), CreateStatDto = x => new StatDto(x.FoldToBTNStealInBB, x.FacedBTNStealInBB) },
            new StatBase { Stat = Stat.FoldToCOStealInSB, PropertyName = nameof(Indicators.FoldToCOStealInSB), CreateStatDto = x => new StatDto(x.FoldToCOStealInSB, x.FacedCOStealInSB) },
            new StatBase { Stat = Stat.FoldToCOStealInBB, PropertyName = nameof(Indicators.FoldToCOStealInBB), CreateStatDto = x => new StatDto(x.FoldToCOStealInBB, x.FacedCOStealInBB) },
            ...
            new StatBase { Stat = Stat.LimpEPFoldToPFR, PropertyName = nameof(Indicators.LimpEPFoldToPFR), CreateStatDto = x => new StatDto(x.LimpEPFoldToPFR, x.LimpEPFacedPFR) },
            new StatBase { Stat = Stat.LimpMPFoldToPFR, PropertyName = nameof(Indicators.LimpMPFoldToPFR), CreateStatDto = x => new StatDto(x.LimpMPFoldToPFR, x.LimpMPFacedPFR) },
            ...
            new StatBase { Stat = Stat.OpenLimpEP, PropertyName = nameof(Indicators.OpenLimpEP), CreateStatDto = x => new StatDto(x.DidOpenLimpEP, x.CouldOpenLimpEP) },
            new StatBase { Stat = Stat.OpenLimpMP, PropertyName = nameof(Indicators.OpenLimpMP), CreateStatDto = x => new StatDto(x.DidOpenLimpMP, x.CouldOpenLimpMP) },
            new StatBase { Stat = Stat.OpenLimpCO, PropertyName = nameof(Indicators.OpenLimpCO), CreateStatDto = x => new StatDto(x.DidOpenLimpCO, x.CouldOpenLimpCO) },
            new StatBase { Stat = Stat.OpenLimpBTN, PropertyName = nameof(Indicators.OpenLimpBTN), CreateStatDto = x => new StatDto(x.DidOpenLimpBTN, x.CouldOpenLimpBTN) },
            new StatBase { Stat = Stat.OpenLimpSB, PropertyName = nameof(Indicators.OpenLimpSB), CreateStatDto = x => new StatDto(x.DidOpenLimpSB, x.CouldOpenLimpSB) },
            ...
            new StatBase { Stat = Stat.EPOpenMinraiseUOPFR, PropertyName = nameof(Indicators.EPOpenMinraiseUOPFR), CreateStatDto = x => new StatDto(x.EPOpenMinraiseUO, x.IsUnopened && x.Position.IsEPPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.MPOpenMinraiseUOPFR, PropertyName = nameof(Indicators.MPOpenMinraiseUOPFR), CreateStatDto = x => new StatDto(x.MPOpenMinraiseUO, x.IsUnopened && x.Position.IsMPPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.COOpenMinraiseUOPFR, PropertyName = nameof(Indicators.COOpenMinraiseUOPFR), CreateStatDto = x => new StatDto(x.COOpenMinraiseUO, x.IsUnopened && x.Position.IsCOPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.BTNOpenMinraiseUOPFR, PropertyName = nameof(Indicators.BTNOpenMinraiseUOPFR), CreateStatDto = x => new StatDto(x.BTNOpenMinraiseUO, x.IsUnopened && x.Position.IsBTNPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.SBOpenMinraiseUOPFR, PropertyName = nameof(Indicators.SBOpenMinraiseUOPFR), CreateStatDto = x => new StatDto(x.SBOpenMinraiseUO, x.IsUnopened && x.Position.IsSBPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.BBOpenMinraiseUOPFR, PropertyName = nameof(Indicators.BBOpenMinraiseUOPFR), CreateStatDto = x => new StatDto(x.BBOpenMinraiseUO, x.IsUnopened && x.Position.IsBBPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.SBOpenShove1to8bbUOPot, PropertyName = nameof(Indicators.SBOpenShove1to8bbUOPot), CreateStatDto = x => new StatDto(x.SBOpenShove1to8bbUOPot, x.SBOpenShoveUOPot) },
            new StatBase { Stat = Stat.SBOpenShove9to14bbUOPot, PropertyName = nameof(Indicators.SBOpenShove9to14bbUOPot), CreateStatDto = x => new StatDto(x.SBOpenShove9to14bbUOPot, x.SBOpenShoveUOPot) },
            new StatBase { Stat = Stat.SBOpenShove15to25bbUOPot, PropertyName = nameof(Indicators.SBOpenShove15to25bbUOPot), CreateStatDto = x => new StatDto(x.SBOpenShove15to25bbUOPot, x.SBOpenShoveUOPot) },
            new StatBase { Stat = Stat.SBOpenShove26to50bbUOPot, PropertyName = nameof(Indicators.SBOpenShove26to50bbUOPot), CreateStatDto = x => new StatDto(x.SBOpenShove26to50bbUOPot, x.SBOpenShoveUOPot) },
            new StatBase { Stat = Stat.SBOpenShove51plusbbUOPot, PropertyName = nameof(Indicators.SBOpenShove51plusbbUOPot), CreateStatDto = x => new StatDto(x.SBOpenShove51plusbbUOPot, x.SBOpenShoveUOPot) },
            new StatBase { Stat = Stat.BTNOpenShove1to8bbUOPot, PropertyName = nameof(Indicators.BTNOpenShove1to8bbUOPot), CreateStatDto = x => new StatDto(x.BTNOpenShove1to8bbUOPot, x.BTNOpenShoveUOPot) },
            new StatBase { Stat = Stat.BTNOpenShove9to14bbUOPot, PropertyName = nameof(Indicators.BTNOpenShove9to14bbUOPot), CreateStatDto = x => new StatDto(x.BTNOpenShove9to14bbUOPot, x.BTNOpenShoveUOPot) },
            new StatBase { Stat = Stat.BTNOpenShove15to25bbUOPot, PropertyName = nameof(Indicators.BTNOpenShove15to25bbUOPot), CreateStatDto = x => new StatDto(x.BTNOpenShove15to25bbUOPot, x.BTNOpenShoveUOPot) },
            new StatBase { Stat = Stat.BTNOpenShove26to50bbUOPot, PropertyName = nameof(Indicators.BTNOpenShove26to50bbUOPot), CreateStatDto = x => new StatDto(x.BTNOpenShove26to50bbUOPot, x.BTNOpenShoveUOPot) },
            new StatBase { Stat = Stat.BTNOpenShove51plusbbUOPot, PropertyName = nameof(Indicators.BTNOpenShove51plusbbUOPot), CreateStatDto = x => new StatDto(x.BTNOpenShove51plusbbUOPot, x.BTNOpenShoveUOPot) },
            new StatBase { Stat = Stat.COOpenShove1to8bbUOPot, PropertyName = nameof(Indicators.COOpenShove1to8bbUOPot), CreateStatDto = x => new StatDto(x.COOpenShove1to8bbUOPot, x.COOpenShoveUOPot) },
            new StatBase { Stat = Stat.COOpenShove9to14bbUOPot, PropertyName = nameof(Indicators.COOpenShove9to14bbUOPot), CreateStatDto = x => new StatDto(x.COOpenShove9to14bbUOPot, x.COOpenShoveUOPot) },
            new StatBase { Stat = Stat.COOpenShove15to25bbUOPot, PropertyName = nameof(Indicators.COOpenShove15to25bbUOPot), CreateStatDto = x => new StatDto(x.COOpenShove15to25bbUOPot, x.COOpenShoveUOPot) },
            new StatBase { Stat = Stat.COOpenShove26to50bbUOPot, PropertyName = nameof(Indicators.COOpenShove26to50bbUOPot), CreateStatDto = x => new StatDto(x.COOpenShove26to50bbUOPot, x.COOpenShoveUOPot) },
            new StatBase { Stat = Stat.COOpenShove51plusbbUOPot, PropertyName = nameof(Indicators.COOpenShove51plusbbUOPot), CreateStatDto = x => new StatDto(x.COOpenShove51plusbbUOPot, x.COOpenShoveUOPot) },
            new StatBase { Stat = Stat.MPOpenShove1to8bbUOPot, PropertyName = nameof(Indicators.MPOpenShove1to8bbUOPot), CreateStatDto = x => new StatDto(x.MPOpenShove1to8bbUOPot, x.MPOpenShoveUOPot) },
            new StatBase { Stat = Stat.MPOpenShove9to14bbUOPot, PropertyName = nameof(Indicators.MPOpenShove9to14bbUOPot), CreateStatDto = x => new StatDto(x.MPOpenShove9to14bbUOPot, x.MPOpenShoveUOPot) },
            new StatBase { Stat = Stat.MPOpenShove15to25bbUOPot, PropertyName = nameof(Indicators.MPOpenShove15to25bbUOPot), CreateStatDto = x => new StatDto(x.MPOpenShove15to25bbUOPot, x.MPOpenShoveUOPot) },
            new StatBase { Stat = Stat.MPOpenShove26to50bbUOPot, PropertyName = nameof(Indicators.MPOpenShove26to50bbUOPot), CreateStatDto = x => new StatDto(x.MPOpenShove26to50bbUOPot, x.MPOpenShoveUOPot) },
            new StatBase { Stat = Stat.MPOpenShove51plusbbUOPot, PropertyName = nameof(Indicators.MPOpenShove51plusbbUOPot), CreateStatDto = x => new StatDto(x.MPOpenShove51plusbbUOPot, x.MPOpenShoveUOPot) },
            new StatBase { Stat = Stat.EPOpenShove1to8bbUOPot, PropertyName = nameof(Indicators.EPOpenShove1to8bbUOPot), CreateStatDto = x => new StatDto(x.EPOpenShove1to8bbUOPot, x.EPOpenShoveUOPot) },
            new StatBase { Stat = Stat.EPOpenShove9to14bbUOPot, PropertyName = nameof(Indicators.EPOpenShove9to14bbUOPot), CreateStatDto = x => new StatDto(x.EPOpenShove9to14bbUOPot, x.EPOpenShoveUOPot) },
            new StatBase { Stat = Stat.EPOpenShove15to25bbUOPot, PropertyName = nameof(Indicators.EPOpenShove15to25bbUOPot), CreateStatDto = x => new StatDto(x.EPOpenShove15to25bbUOPot, x.EPOpenShoveUOPot) },
            new StatBase { Stat = Stat.EPOpenShove26to50bbUOPot, PropertyName = nameof(Indicators.EPOpenShove26to50bbUOPot), CreateStatDto = x => new StatDto(x.EPOpenShove26to50bbUOPot, x.EPOpenShoveUOPot) },
            new StatBase { Stat = Stat.EPOpenShove51plusbbUOPot, PropertyName = nameof(Indicators.EPOpenShove51plusbbUOPot), CreateStatDto = x => new StatDto(x.EPOpenShove51plusbbUOPot, x.EPOpenShoveUOPot) },
            new StatBase { Stat = Stat.PFR, PropertyName = nameof(Indicators.PFR), CreateStatDto = x => new StatDto(x.Pfrhands, x.Totalhands) },
            new StatBase { Stat = Stat.PFRInBB, PropertyName = nameof(Indicators.PFRInBB), CreateStatDto = x => new StatDto(x.PfrInBb, x.Position.IsBBPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.PFRInBTN, PropertyName = nameof(Indicators.PFRInBTN), CreateStatDto = x => new StatDto(x.PfrInBtn, x.Position.IsBTNPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.PFRInCO, PropertyName = nameof(Indicators.PFRInCO), CreateStatDto = x => new StatDto(x.PfrInCo, x.Position.IsCOPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.PFRInEP, PropertyName = nameof(Indicators.PFRInEP), CreateStatDto = x => new StatDto(x.PfrInEp, x.Position.IsEPPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.PFRInMP, PropertyName = nameof(Indicators.PFRInMP), CreateStatDto = x => new StatDto(x.PfrInMp, x.Position.IsMPPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.PFRInSB, PropertyName = nameof(Indicators.PFRInSB), CreateStatDto = x => new StatDto(x.PfrInSb, x.Position.IsSBPosition() ? 1 : 0) },
            new StatBase { Stat = Stat.PFRInStraddle, PropertyName = nameof(Indicators.PFRInStraddle), CreateStatDto = x => new StatDto(x.DidPFRInStraddle, x.CouldActInStraddle) },
            ...
            new StatBase { Stat = Stat.RiverCBet, PropertyName = nameof(Indicators.RiverCBet), CreateStatDto = x => new StatDto(x.Rivercontinuationbetmade, x.Rivercontinuationbetpossible) },
            ...
            new StatBase { Stat = Stat.RiverFoldInSRP, PropertyName = nameof(Indicators.RiverFoldInSRP), CreateStatDto = x => new StatDto(x.DidRiverFoldInSRP, x.CouldRiverFoldInSRP) },
            new StatBase { Stat = Stat.RiverFoldIn3Bet, PropertyName = nameof(Indicators.RiverFoldIn3Bet), CreateStatDto = x => new StatDto(x.DidRiverFoldIn3Bet, x.CouldRiverFoldIn3Bet) },
            new StatBase { Stat = Stat.RiverFoldIn4Bet, PropertyName = nameof(Indicators.RiverFoldIn4Bet), CreateStatDto = x => new StatDto(x.DidRiverFoldIn4Bet, x.CouldRiverFoldIn4Bet) },
            ...
            new StatBase { Stat = Stat.FourBetInStraddle, PropertyName = nameof(HudLightIndicators.FourBetInStraddle), CreateStatDto = x => new StatDto(x.Did4BetInStraddle, x.Could4BetInStraddle) },
            new StatBase { Stat = Stat.FourBetVsBlind3Bet, PropertyName = nameof(Indicators.FourBetVsBlind3Bet), CreateStatDto = x => new StatDto(x.Did4BetVsBlind3Bet, x.Could4BetVsBlind3Bet) },
            ...
            new StatBase { Stat = Stat.SkipFlopCBetInSRPandCheckFoldFlopOOP, PropertyName = nameof(Indicators.SkipFlopCBetInSRPandCheckFoldFlopOOP), CreateStatDto = x => new StatDto(x.DidSkipFlopCBetInSRPandCheckFoldFlopOOP, x.CouldSkipFlopCBetInSRPandCheckFoldFlopOOP) },
            ...
            new StatBase { Stat = Stat.SqueezeEP, PropertyName = nameof(Indicators.SqueezeEP), CreateStatDto = x => new StatDto(x.DidSqueezeEP, x.CouldSqueezeEP) },
            new StatBase { Stat = Stat.SqueezeMP, PropertyName = nameof(Indicators.SqueezeMP), CreateStatDto = x => new StatDto(x.DidSqueezeMP, x.CouldSqueezeMP) },
            new StatBase { Stat = Stat.SqueezeCO, PropertyName = nameof(Indicators.SqueezeCO), CreateStatDto = x => new StatDto(x.DidSqueezeCO, x.CouldSqueezeCO) },
            new StatBase { Stat = Stat.SqueezeBTN, PropertyName = nameof(Indicators.SqueezeBTN), CreateStatDto = x => new StatDto(x.DidSqueezeBTN, x.CouldSqueezeBTN) },
            new StatBase { Stat = Stat.SqueezeSB, PropertyName = nameof(Indicators.SqueezeSB), CreateStatDto = x => new StatDto(x.DidSqueezeSB, x.CouldSqueezeSB) },
            new StatBase { Stat = Stat.SqueezeBB, PropertyName = nameof(Indicators.SqueezeBB), CreateStatDto = x => new StatDto(x.DidSqueezeBB, x.CouldSqueezeBB) },
            new StatBase { Stat = Stat.SqueezeBBVsBTNPFR, PropertyName = nameof(Indicators.SqueezeBBVsBTNPFR), CreateStatDto = x => new StatDto(x.DidSqueezeBBVsBTNPFR, x.CouldSqueezeBBVsBTNPFR) },
            new StatBase { Stat = Stat.SqueezeBBVsCOPFR, PropertyName = nameof(Indicators.SqueezeBBVsCOPFR), CreateStatDto = x => new StatDto(x.DidSqueezeBBVsCOPFR, x.CouldSqueezeBBVsCOPFR) },
            new StatBase { Stat = Stat.SqueezeBBVsMPPFR, PropertyName = nameof(Indicators.SqueezeBBVsMPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeBBVsMPPFR, x.CouldSqueezeBBVsMPPFR) },
            new StatBase { Stat = Stat.SqueezeBBVsEPPFR, PropertyName = nameof(Indicators.SqueezeBBVsEPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeBBVsEPPFR, x.CouldSqueezeBBVsEPPFR) },
            new StatBase { Stat = Stat.SqueezeSBVsCOPFR, PropertyName = nameof(Indicators.SqueezeSBVsCOPFR), CreateStatDto = x => new StatDto(x.DidSqueezeSBVsCOPFR, x.CouldSqueezeSBVsCOPFR) },
            new StatBase { Stat = Stat.SqueezeSBVsMPPFR, PropertyName = nameof(Indicators.SqueezeSBVsMPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeSBVsMPPFR, x.CouldSqueezeSBVsMPPFR) },
            new StatBase { Stat = Stat.SqueezeSBVsEPPFR, PropertyName = nameof(Indicators.SqueezeSBVsEPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeSBVsEPPFR, x.CouldSqueezeSBVsEPPFR) },
            new StatBase { Stat = Stat.SqueezeBTNVsMPPFR, PropertyName = nameof(Indicators.SqueezeBTNVsMPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeBTNVsMPPFR, x.CouldSqueezeBTNVsMPPFR) },
            new StatBase { Stat = Stat.SqueezeBTNVsEPPFR, PropertyName = nameof(Indicators.SqueezeBTNVsEPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeBTNVsEPPFR, x.CouldSqueezeBTNVsEPPFR) },
            new StatBase { Stat = Stat.SqueezeCOVsMPPFR, PropertyName = nameof(Indicators.SqueezeCOVsMPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeCOVsMPPFR, x.CouldSqueezeCOVsMPPFR) },
            new StatBase { Stat = Stat.SqueezeCOVsEPPFR, PropertyName = nameof(Indicators.SqueezeCOVsEPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeCOVsEPPFR, x.CouldSqueezeCOVsEPPFR) },
            new StatBase { Stat = Stat.SqueezeMPVsEPPFR, PropertyName = nameof(Indicators.SqueezeMPVsEPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeMPVsEPPFR, x.CouldSqueezeMPVsEPPFR) },
            new StatBase { Stat = Stat.SqueezeEPVsEPPFR, PropertyName = nameof(Indicators.SqueezeEPVsEPPFR), CreateStatDto = x => new StatDto(x.DidSqueezeEPVsEPPFR, x.CouldSqueezeEPVsEPPFR) },
            ...
            new StatBase { Stat = Stat.SBShoveOverLimpers26to50bb, PropertyName = nameof(Indicators.SBShoveOverLimpers26to50bb), CreateStatDto = x => new StatDto(x.SBShoveOverLimpers26to50bb, x.SBShoveOverLimpers) },
            new StatBase { Stat = Stat.SBShoveOverLimpers51plusbb, PropertyName = nameof(Indicators.SBShoveOverLimpers51plusbb), CreateStatDto = x => new StatDto(x.SBShoveOverLimpers51plusbb, x.SBShoveOverLimpers) },
            new StatBase { Stat = Stat.BTNShoveOverLimpers1to8bb, PropertyName = nameof(Indicators.BTNShoveOverLimpers1to8bb), CreateStatDto = x => new StatDto(x.BTNShoveOverLimpers1to8bb, x.BTNShoveOverLimpers) },
            new StatBase { Stat = Stat.BTNShoveOverLimpers9to14bb, PropertyName = nameof(Indicators.BTNShoveOverLimpers9to14bb), CreateStatDto = x => new StatDto(x.BTNShoveOverLimpers9to14bb, x.BTNShoveOverLimpers) },
            new StatBase { Stat = Stat.BTNShoveOverLimpers15to25bb, PropertyName = nameof(Indicators.BTNShoveOverLimpers15to25bb), CreateStatDto = x => new StatDto(x.BTNShoveOverLimpers15to25bb, x.BTNShoveOverLimpers) },
            new StatBase { Stat = Stat.BTNShoveOverLimpers26to50bb, PropertyName = nameof(Indicators.BTNShoveOverLimpers26to50bb), CreateStatDto = x => new StatDto(x.BTNShoveOverLimpers26to50bb, x.BTNShoveOverLimpers) },
            new StatBase { Stat = Stat.BTNShoveOverLimpers51plusbb, PropertyName = nameof(Indicators.BTNShoveOverLimpers51plusbb), CreateStatDto = x => new StatDto(x.BTNShoveOverLimpers51plusbb, x.BTNShoveOverLimpers) },
            new StatBase { Stat = Stat.COShoveOverLimpers1to8bb, PropertyName = nameof(Indicators.COShoveOverLimpers1to8bb), CreateStatDto = x => new StatDto(x.COShoveOverLimpers1to8bb, x.COShoveOverLimpers) },
            new StatBase { Stat = Stat.COShoveOverLimpers9to14bb, PropertyName = nameof(Indicators.COShoveOverLimpers9to14bb), CreateStatDto = x => new StatDto(x.COShoveOverLimpers9to14bb, x.COShoveOverLimpers) },
            new StatBase { Stat = Stat.COShoveOverLimpers15to25bb, PropertyName = nameof(Indicators.COShoveOverLimpers15to25bb), CreateStatDto = x => new StatDto(x.COShoveOverLimpers15to25bb, x.COShoveOverLimpers) },
            new StatBase { Stat = Stat.COShoveOverLimpers26to50bb, PropertyName = nameof(Indicators.COShoveOverLimpers26to50bb), CreateStatDto = x => new StatDto(x.COShoveOverLimpers26to50bb, x.COShoveOverLimpers) },
            new StatBase { Stat = Stat.COShoveOverLimpers51plusbb, PropertyName = nameof(Indicators.COShoveOverLimpers51plusbb), CreateStatDto = x => new StatDto(x.COShoveOverLimpers51plusbb, x.COShoveOverLimpers) },
            new StatBase { Stat = Stat.MPShoveOverLimpers1to8bb, PropertyName = nameof(Indicators.MPShoveOverLimpers1to8bb), CreateStatDto = x => new StatDto(x.MPShoveOverLimpers1to8bb, x.MPShoveOverLimpers) },
            new StatBase { Stat = Stat.MPShoveOverLimpers9to14bb, PropertyName = nameof(Indicators.MPShoveOverLimpers9to14bb), CreateStatDto = x => new StatDto(x.MPShoveOverLimpers9to14bb, x.MPShoveOverLimpers) },
            new StatBase { Stat = Stat.MPShoveOverLimpers15to25bb, PropertyName = nameof(Indicators.MPShoveOverLimpers15to25bb), CreateStatDto = x => new StatDto(x.MPShoveOverLimpers15to25bb, x.MPShoveOverLimpers) },
            new StatBase { Stat = Stat.MPShoveOverLimpers26to50bb, PropertyName = nameof(Indicators.MPShoveOverLimpers26to50bb), CreateStatDto = x => new StatDto(x.MPShoveOverLimpers26to50bb, x.MPShoveOverLimpers) },
            new StatBase { Stat = Stat.MPShoveOverLimpers51plusbb, PropertyName = nameof(Indicators.MPShoveOverLimpers51plusbb), CreateStatDto = x => new StatDto(x.MPShoveOverLimpers51plusbb, x.MPShoveOverLimpers) },
            new StatBase { Stat = Stat.EPShoveOverLimpers1to8bb, PropertyName = nameof(Indicators.EPShoveOverLimpers1to8bb), CreateStatDto = x => new StatDto(x.EPShoveOverLimpers1to8bb, x.EPShoveOverLimpers) },
            new StatBase { Stat = Stat.EPShoveOverLimpers9to14bb, PropertyName = nameof(Indicators.EPShoveOverLimpers9to14bb), CreateStatDto = x => new StatDto(x.EPShoveOverLimpers9to14bb, x.EPShoveOverLimpers) },
            new StatBase { Stat = Stat.EPShoveOverLimpers15to25bb, PropertyName = nameof(Indicators.EPShoveOverLimpers15to25bb), CreateStatDto = x => new StatDto(x.EPShoveOverLimpers15to25bb, x.EPShoveOverLimpers) },
            new StatBase { Stat = Stat.EPShoveOverLimpers26to50bb, PropertyName = nameof(Indicators.EPShoveOverLimpers26to50bb), CreateStatDto = x => new StatDto(x.EPShoveOverLimpers26to50bb, x.EPShoveOverLimpers) },
            new StatBase { Stat = Stat.EPShoveOverLimpers51plusbb, PropertyName = nameof(Indicators.EPShoveOverLimpers51plusbb), CreateStatDto = x => new StatDto(x.EPShoveOverLimpers51plusbb, x.EPShoveOverLimpers) },
            ...
            new StatBase { Stat = Stat.ThreeBetInStraddle, PropertyName = nameof(HudLightIndicators.ThreeBetInStraddle), CreateStatDto = x => new StatDto(x.Did3BetInStraddle, x.Could3BetInStraddle) },
            ...
            new StatBase { Stat = Stat.TripleBarrel, PropertyName = nameof(Indicators.TripleBarrel), CreateStatDto = x => new StatDto(x.DidTripleBarrel, x.CouldTripleBarrel) },
            ...
            new StatBase { Stat = Stat.TurnCBet, PropertyName = nameof(Indicators.TurnCBet), CreateStatDto = x => new StatDto(x.Turncontinuationbetmade, x.Turncontinuationbetpossible) },
            ...
            new StatBase { Stat = Stat.WTSDInStraddle, PropertyName = nameof(Indicators.WTSDInStraddle), CreateStatDto = x => new StatDto(x.WTSDInStraddle, x.WTSDOpportunityInStraddle) },
        ...
        public static IEnumerable<StatInfo> GetAllStats()
        {
            ...
            var statsCollection = new[]
            {
                ...
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.ThreeBetInStraddle },
                ...
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.FourBetInStraddle },
                ...
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.OpenLimpEP },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.OpenLimpMP },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.OpenLimpCO },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.OpenLimpBTN },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.OpenLimpSB },

                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.EPOpenMinraiseUOPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.MPOpenMinraiseUOPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.COOpenMinraiseUOPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.BTNOpenMinraiseUOPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SBOpenMinraiseUOPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.BBOpenMinraiseUOPFR },

                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeEP },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeMP },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeCO },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeBTN },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeSB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeBB },

                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeBBVsBTNPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeBBVsCOPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeBBVsMPPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeBBVsEPPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeSBVsCOPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeSBVsMPPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeSBVsEPPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeBTNVsMPPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeBTNVsEPPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeCOVsMPPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeCOVsEPPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeMPVsEPPFR },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.SqueezeEPVsEPPFR },
                ...
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.CalledStealInSB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.CalledStealInBB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.FoldToBTNStealInSB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.FoldToBTNStealInBB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.FoldToCOStealInSB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.FoldToCOStealInBB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.CalledBTNStealInSB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.CalledBTNStealInBB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.CalledCOStealInSB },
                new StatInfo { GroupName = "2", StatInfoGroup = statInfoGroups[1], Stat = Stat.CalledCOStealInBB },
                ...
                new StatInfo { GroupName = "3", StatInfoGroup = statInfoGroups[2], Stat = Stat.ThreeBetInStraddle },
                ...
                new StatInfo { GroupName = "3", StatInfoGroup = statInfoGroups[2], Stat = Stat.Call3Bet },
                new StatInfo { GroupName = "3", StatInfoGroup = statInfoGroups[2], Stat = Stat.Call3BetIP },
                new StatInfo { GroupName = "3", StatInfoGroup = statInfoGroups[2], Stat = Stat.Call3BetOOP },
                new StatInfo { GroupName = "3", StatInfoGroup = statInfoGroups[2], Stat = Stat.Call3BetEP },
                new StatInfo { GroupName = "3", StatInfoGroup = statInfoGroups[2], Stat = Stat.Call3BetMP },
                new StatInfo { GroupName = "3", StatInfoGroup = statInfoGroups[2], Stat = Stat.Call3BetCO },
                new StatInfo { GroupName = "3", StatInfoGroup = statInfoGroups[2], Stat = Stat.Call3BetBTN },
                new StatInfo { GroupName = "3", StatInfoGroup = statInfoGroups[2], Stat = Stat.Call3BetSB },
                ...
                new StatInfo { GroupName = "4", StatInfoGroup = statInfoGroups[3], Stat = Stat.FourBetInStraddle },
                ...
                new StatInfo { GroupName = "4", StatInfoGroup = statInfoGroups[3], Stat = Stat.Call4Bet },
                ...
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.CheckInStraddle },
                ...
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.ThreeBetInStraddle },
                ...
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.FoldToSqueezeAsColdCaller },
                ...
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.FoldInStraddle },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.PFRInStraddle },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.OpenMinraise },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBOpenShove1to8bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBOpenShove9to14bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBOpenShove15to25bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBOpenShove26to50bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBOpenShove51plusbbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNOpenShove1to8bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNOpenShove9to14bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNOpenShove15to25bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNOpenShove26to50bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNOpenShove51plusbbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COOpenShove1to8bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COOpenShove9to14bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COOpenShove15to25bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COOpenShove26to50bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COOpenShove51plusbbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPOpenShove1to8bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPOpenShove9to14bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPOpenShove15to25bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPOpenShove26to50bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPOpenShove51plusbbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.EPOpenShove1to8bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.EPOpenShove9to14bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.EPOpenShove15to25bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.EPOpenShove26to50bbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.EPOpenShove51plusbbUOPot },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBShoveOverLimpers1to8bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBShoveOverLimpers9to14bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBShoveOverLimpers15to25bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBShoveOverLimpers26to50bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.SBShoveOverLimpers51plusbb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNShoveOverLimpers1to8bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNShoveOverLimpers9to14bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNShoveOverLimpers15to25bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNShoveOverLimpers26to50bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.BTNShoveOverLimpers51plusbb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COShoveOverLimpers1to8bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COShoveOverLimpers9to14bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COShoveOverLimpers15to25bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COShoveOverLimpers26to50bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.COShoveOverLimpers51plusbb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPShoveOverLimpers1to8bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPShoveOverLimpers9to14bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPShoveOverLimpers15to25bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPShoveOverLimpers26to50bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.MPShoveOverLimpers51plusbb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.EPShoveOverLimpers1to8bb },
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.EPShoveOverLimpers9to14bb },
                ...
                new StatInfo { GroupName = "5", StatInfoGroup = statInfoGroups[4], Stat = Stat.WTSDInStraddle },
                ...
                new StatInfo { GroupName = "6", StatInfoGroup = statInfoGroups[5], Stat = Stat.CheckRaiseFlopAsPFRInSRP },
                new StatInfo { GroupName = "6", StatInfoGroup = statInfoGroups[5], Stat = Stat.CheckRaiseFlopAsPFRIn3BetPot },
                ...
                new StatInfo { GroupName = "6", StatInfoGroup = statInfoGroups[5], Stat = Stat.SkipFlopCBetInSRPandCheckFoldFlopOOP },
                ...
                new StatInfo { GroupName = "7", StatInfoGroup = statInfoGroups[6], Stat = Stat.DelayedTurnCBetInSRP },
                new StatInfo { GroupName = "7", StatInfoGroup = statInfoGroups[6], Stat = Stat.DelayedTurnCBetIn4BetPot },
                ...
                new StatInfo { GroupName = "7", StatInfoGroup = statInfoGroups[6], Stat = Stat.FoldedToDelayedCBet },
                ...
                new StatInfo { GroupName = "7", StatInfoGroup = statInfoGroups[6], Stat = Stat.TurnCBet },
                ...
                new StatInfo { GroupName = "8", StatInfoGroup = statInfoGroups[7], Stat = Stat.RiverCBet },
                ...
                new StatInfo { GroupName = "8", StatInfoGroup = statInfoGroups[7], Stat = Stat.RiverFoldInSRP },
                new StatInfo { GroupName = "8", StatInfoGroup = statInfoGroups[7], Stat = Stat.RiverFoldIn3Bet },
                new StatInfo { GroupName = "8", StatInfoGroup = statInfoGroups[7], Stat = Stat.RiverFoldIn4Bet },
                ...
                new StatInfo { GroupName = "92", StatInfoGroup = statInfoGroups[10], Stat = Stat.LimpEPFoldToPFR },
                new StatInfo { GroupName = "92", StatInfoGroup = statInfoGroups[10], Stat = Stat.LimpMPFoldToPFR },
