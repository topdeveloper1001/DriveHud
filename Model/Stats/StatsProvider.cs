...
namespace Model.Stats
{
    ...
    public class StatsProvider
    {
        ...
        public static ReadOnlyDictionary<Stat, StatBase> StatsBases = new ReadOnlyDictionary<Stat, StatBase>((new[]
        {
            ...
            new StatBase { Stat = Stat.BetFlopCalled3BetPreflopIp, PropertyName = nameof(Indicators.BetFlopCalled3BetPreflopIp), CreateStatDto = x => new StatDto(x.BetFlopCalled3BetPreflopIp, x.Totalhands) },
            new StatBase { Stat = Stat.BetFoldFlopPfrRaiser, PropertyName = nameof(Indicators.BetFoldFlopPfrRaiser), CreateStatDto = x => new StatDto(x.BetFoldFlopPfrRaiser, x.Pfrhands) },
