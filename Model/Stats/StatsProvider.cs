...
namespace Model.Stats
{
    ...
    public class StatsProvider
    {
        ...
        public static ReadOnlyDictionary<Stat, StatBase> StatsBases = new ReadOnlyDictionary<Stat, StatBase>((new[]
        {
            ...
            new StatBase { Stat = Stat.BetFlopCalled3BetPreflopIp, PropertyName = nameof(Indicators.BetFlopCalled3BetPreflopIp) },
            new StatBase { Stat = Stat.BetFoldFlopPfrRaiser, PropertyName = nameof(Indicators.BetFoldFlopPfrRaiser) },
            ...
            new StatBase { Stat = Stat.BTNDefendCORaise, PropertyName = nameof(Indicators.BTNDefendCORaise) },
            ...
            new StatBase { Stat = Stat.CheckFoldFlop3BetOop, PropertyName = nameof(Indicators.CheckFoldFlop3BetOop) },
            new StatBase { Stat = Stat.CheckFoldFlopPfrOop, PropertyName = nameof(Indicators.CheckFoldFlopPfrOop) },
            ...
            new StatBase { Stat = Stat.CheckRiverOnBXLine, PropertyName = nameof(Indicators.CheckRiverOnBXLine) },
            new StatBase { Stat = Stat.ColdCall_BB, PropertyName = nameof(HudLightIndicators.ColdCall_BB) },
            new StatBase { Stat = Stat.ColdCall_BN, PropertyName = nameof(HudLightIndicators.ColdCall_BN) },
            new StatBase { Stat = Stat.ColdCall_CO, PropertyName = nameof(HudLightIndicators.ColdCall_CO) },
            new StatBase { Stat = Stat.ColdCall_EP, PropertyName = nameof(HudLightIndicators.ColdCall_EP) },
            new StatBase { Stat = Stat.ColdCall_MP, PropertyName = nameof(HudLightIndicators.ColdCall_MP) },
            new StatBase { Stat = Stat.ColdCall_SB, PropertyName = nameof(HudLightIndicators.ColdCall_SB) },
            ...
            new StatBase { Stat = Stat.ColdCallFourBet, PropertyName = nameof(Indicators.ColdCallFourBet) },
            new StatBase { Stat = Stat.ColdCallThreeBet, PropertyName = nameof(Indicators.ColdCallThreeBet) },
            new StatBase { Stat = Stat.ColdCallVsOpenRaiseBTN, PropertyName = nameof(Indicators.ColdCallVsBtnOpen) },
            new StatBase { Stat = Stat.ColdCallVsOpenRaiseCO, PropertyName = nameof(Indicators.ColdCallVsCoOpen) },
            new StatBase { Stat = Stat.ColdCallVsOpenRaiseSB, PropertyName = nameof(Indicators.ColdCallVsSbOpen) },
            new StatBase { Stat = Stat.DelayedTurnCBet, PropertyName = nameof(Indicators.DidDelayedTurnCBet) },
            new StatBase { Stat = Stat.DonkBet, PropertyName = nameof(Indicators.DonkBet) },
            new StatBase { Stat = Stat.DoubleBarrel, PropertyName = nameof(Indicators.TurnCBet) },
            new StatBase { Stat = Stat.FloatFlop, PropertyName = nameof(Indicators.FloatFlop)},
            ...
            new StatBase { Stat = Stat.FlopCBetMonotone, PropertyName = nameof(Indicators.FlopCBetMonotone) },
            new StatBase { Stat = Stat.FlopCBetMW, PropertyName = nameof(Indicators.FlopCBetMW) },
            new StatBase { Stat = Stat.FlopCBetRag, PropertyName = nameof(Indicators.FlopCBetRag) },
            new StatBase { Stat = Stat.FlopCBetVsOneOpp, PropertyName = nameof(Indicators.FlopCBetVsOneOpp) },
            new StatBase { Stat = Stat.FlopCBetVsTwoOpp, PropertyName = nameof(Indicators.FlopCBetVsTwoOpp) },
            new StatBase { Stat = Stat.FlopCheckRaise, PropertyName = nameof(Indicators.FlopCheckRaise) },
            ...
            new StatBase { Stat = Stat.FoldToFlopRaise, PropertyName = nameof(Indicators.FoldToFlopRaise) },
            new StatBase { Stat = Stat.FoldToRiverCBet, PropertyName = nameof(Indicators.FoldToRiverCBet) },
            new StatBase { Stat = Stat.FoldToSqueez, PropertyName = nameof(Indicators.FoldToSqueez) },
            ...
            new StatBase { Stat = Stat.FoldToTurnRaise, PropertyName = nameof(Indicators.FoldToTurnRaise) },
            new StatBase { Stat = Stat.Limp, PropertyName = nameof(Indicators.DidLimp) },
            ...
            new StatBase { Stat = Stat.LimpCall, PropertyName = nameof(Indicators.DidLimpCall) },
            ...
            new StatBase { Stat = Stat.LimpFold, PropertyName = nameof(Indicators.DidLimpFold) },
            new StatBase { Stat = Stat.LimpMp, PropertyName = nameof(Indicators.LimpMp), CreateStatDto = x => new StatDto(x.LimpMp, x.LimpPossible) },
            new StatBase { Stat = Stat.LimpReraise, PropertyName = nameof(Indicators.DidLimpReraise) },
            ...
            new StatBase { Stat = Stat.RaiseCBet, PropertyName = nameof(Indicators.RaiseCBet) },
            new StatBase { Stat = Stat.RaiseFlop, PropertyName = nameof(Indicators.RaiseFlop) },
            new StatBase { Stat = Stat.RaiseFrequencyFactor, PropertyName = nameof(Indicators.RaiseFrequencyFactor) },
            new StatBase { Stat = Stat.RaiseRiver, PropertyName = nameof(Indicators.RaiseRiver) },
            new StatBase { Stat = Stat.RaiseTurn, PropertyName = nameof(Indicators.RaiseTurn) },
            ...
            new StatBase { Stat = Stat.RiverSeen, PropertyName = nameof(Indicators.RiverSeen) },
            ...
            new StatBase { Stat = Stat.TrueAggression, PropertyName = nameof(Indicators.TrueAggression) },
            ...
            new StatBase { Stat = Stat.TurnCheckRaise, PropertyName = nameof(Indicators.TurnCheckRaise) },
            new StatBase { Stat = Stat.TurnSeen, PropertyName = nameof(Indicators.TurnSeen) },
