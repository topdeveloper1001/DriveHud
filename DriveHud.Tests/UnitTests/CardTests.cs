//-----------------------------------------------------------------------
// <copyright file="CardTests.cs" company="Ace Poker Solutions">
...
namespace DriveHud.Tests.UnitTests
{
    ...
    class CardTests
    {
        ...
        public void TestGetCardRanges()
        {
            ...
            var actual = string.Join(" ", HandHistories.Objects.Cards.Card.GetCardRanges());
