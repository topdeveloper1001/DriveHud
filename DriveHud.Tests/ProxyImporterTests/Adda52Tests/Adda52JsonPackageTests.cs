    ...
    {        
        ...
        public static IEnumerable<TestCaseData> TestAdd52Packages()
        {
            ...
            yield return new TestCaseData(
                ...
                Adda52PackageType.AccessToken)
            { TestName = "TryParseAccessTokenTest" };
            ...
            yield return new TestCaseData(
                ...
                Adda52PackageType.MTTInfo)
            { TestName = "TryParseMTTInfoTest" };
            ...
            yield return new TestCaseData(
                ...
                Adda52PackageType.MTTTables)
            { TestName = "TryParseMTTTableInfoTest" };
        }
    }
}