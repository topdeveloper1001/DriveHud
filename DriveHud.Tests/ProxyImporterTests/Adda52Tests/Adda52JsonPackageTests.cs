...
namespace DriveHud.Tests.ProxyImporterTests.Adda52Tests
{
    ...
    class Adda52JsonPackageTests
    {
        ...
        public static IEnumerable<TestCaseData> TestAdd52Packages
        {
            get
            {
                yield return new TestCaseData(
                    ...
                    Adda52PackageType.SeatInfo).SetName("TryParseSeatInfoTest");
                ...
                yield return new TestCaseData(
                    ...
                    Adda52PackageType.CommunityCard).SetName("TryParseCommunityCardTest");
                ...
                yield return new TestCaseData(
                    ...
                    Adda52PackageType.Winner).SetName("TryParseWinnerTest");
                ...
                yield return new TestCaseData(
                    ...
                    Adda52PackageType.UncalledBet).SetName("TryParseUncalledBetTest");

                yield return new TestCaseData(
                    "{\"c\":1,\"p\":{\"c\":\"user.accesstoken\",\"p\":{\"sToken\":\"3ea6468f-5c99-4277-93b3-3c800aa35f61\",\"userId\":1778828}},\"a\":13}",
                    Adda52PackageType.AccessToken).SetName("TryParseAccessTokenTest");

                yield return new TestCaseData(
                    "{\"c\":1,\"p\":{\"c\":\"mtt.info\",\"r\":59166,\"p\":{\"isAddonEnabled\":false,\"mttType\":\"nonrealentry_prizetable_fixed\",\"blindIncTime\":5,\"roomName\":\"MTTLobby#71680\",\"useConverter\":false,\"isLateRegEnabled\":false,\"MttInfo\":{\"addonThreshold\":600,\"addonTime\":0,\"bigBlindMultiple\":0,\"blindTypeId\":0,\"bountyAmount\":0,\"comissionRate\":0,\"disunreg\":false,\"entryChipInfo\":{\"entryChips\":[{\"amt\":5000,\"initAmt\":2000,\"type\":\"Freeroll\"}]},\"finalAddon\":false,\"finalAddonAmt\":0,\"isBountyTourney\":false,\"isBreakTourney\":true,\"isLateReg\":true,\"isRebuy\":true,\"isReentertourney\":false,\"lateregtime\":35,\"ltyet\":\"\",\"ltyst\":\"\",\"maxAddons\":-1,\"maxRebuys\":4,\"minLateReg\":0,\"mip\":3,\"mtst\":\"Sep 19, 2018 17:00:30\",\"mxp\":0,\"prizeStruc\":false,\"rebuyChipInfo\":{\"entryChips\":[{\"amt\":10,\"initAmt\":2000,\"type\":\"real\"}]},\"rebuyNx\":2,\"rebuyTime\":45,\"reenterCount\":0,\"rget\":\"Sep 19, 2018 17:35:30\",\"rgp\":86,\"rgst\":\"Sep 19, 2018 00:00:00\",\"specificPlayerBounty\":false,\"tourneyFormat\":\"MTT\",\"tourneyLevel\":1,\"tourneyLevelInfo\":\"\"},\"sId\":1,\"isRebuyEnabled\":false,\"isWinTheButtonEnabled\":false}},\"a\":13}",
                    Adda52PackageType.MTTInfo).SetName("TryParseMTTInfoTest");

                yield return new TestCaseData(
                    "{\"c\":1,\"p\":{\"c\":\"mtt.tables\",\"r\":59166,\"p\":{\"roomName\":\"MTTLobby#71680\",\"useConverter\":false,\"MttTableInfo\":{\"mttPrizes\":[{\"lt\":483556,\"pl\":2,\"players\":[873758,1448156],\"st\":196444,\"tbl\":\"MTT9#3194080\"}]}}},\"a\":13}",
                    Adda52PackageType.MTTTables).SetName("TryParseMTTTableInfoTest");

                yield return new TestCaseData(
                    "{\"c\":1,\"p\":{\"c\":\"mtt.prizes\",\"r\":59190,\"p\":{\"roomName\":\"MTTLobby#71704\",\"useConverter\":false,\"MttPrizeInfo\":{\"chipType\":\"real\",\"gameDetail\":\"Super 200\",\"mttPrizes\":[{\"chipType\":\"real\",\"prize\":11250,\"prizeDL\":\"\",\"prizePercent\":45,\"rnk\":1,\"uid\":0,\"usr\":\"Winner_1\"},{\"chipType\":\"real\",\"prize\":6250,\"prizeDL\":\"\",\"prizePercent\":25,\"rnk\":2,\"uid\":0,\"usr\":\"Winner_2\"},{\"chipType\":\"real\",\"prize\":4500,\"prizeDL\":\"\",\"prizePercent\":18,\"rnk\":3,\"uid\":0,\"usr\":\"Winner_3\"},{\"chipType\":\"real\",\"prize\":3000,\"prizeDL\":\"\",\"prizePercent\":12,\"rnk\":4,\"uid\":0,\"usr\":\"Winner_4\"}]}}},\"a\":13}",
                    Adda52PackageType.MTTPrizes).SetName("TryParseMTTPrizesTest");
            }
        }
    }
}