...
namespace DriveHUD.EquityCalculator.Analyzer
{
    internal class Combination
    {
        ...
        internal Combination(long n, long k)
        {
        ...
        internal Combination(long n, long k, long[] a) // Combination from a[]
        {
            if (k != a.Length)
        ...
        internal string[] ApplyTo(string[] strarr)
        {
        ...
        internal static long Choose(long n, long k)
        {
            if (n < 0 || k < 0)
