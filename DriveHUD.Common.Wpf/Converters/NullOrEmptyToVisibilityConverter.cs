//-----------------------------------------------------------------------
// <copyright file="NullOrEmptyToVisibilityConverter.cs" company="Ace Poker Solutions">
...
{
    public class NullOrEmptyToVisibilityConverter : MarkupExtensionConverterBase
    {
        ...
        {
            var result = value != null ? string.IsNullOrEmpty(value.ToString()) : true;
