//-----------------------------------------------------------------------
// <copyright file="WpfViewModel.cs" company="Ace Poker Solutions">
...
{
    public abstract class WpfViewModelBase<TViewModel> : ViewModelBase, INotifyDataErrorInfo, IValidationAsync
        where TViewModel : WpfViewModelBase<TViewModel>
    {
        #region Fields
