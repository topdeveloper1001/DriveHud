...
namespace DriveHUD.Application.Licensing
{
    ...
    internal partial class DeployLXLicensingServer : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        private System.Threading.SendOrPostCallback RegisterTrialV2OperationCompleted;
        ...
        {
            this.Url = "http://support.acepokersolutions.com/LicensingWS/LicenseServerDriveHUD.asmx";
        }
        ...
        /// <remarks/>
        public event RegisterTrialV2CompletedEventHandler RegisterTrialV2Completed;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.xheo.com/licensing/v3_0/CreateSession", RequestNamespace = "http://www.xheo.com/licensing/v3_0", ResponseNamespace = "http://www.xheo.com/licensing/v3_0", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        public byte[] EndCreateSession(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((byte[])(results[0]));
        }
        ...
        public string RegisterTrial(string text, string email)
        {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginRegisterTrial(string text, string email, System.AsyncCallback callback, object asyncState)
        {
        ...
        /// <remarks/>
        public void RegisterTrialAsync(string text, string email)
        {
            this.RegisterTrialAsync(text, email, null);
        }

        /// <remarks/>
        public void RegisterTrialAsync(string text, string email, object userState)
        {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://www.xheo.com/licensing/v3_0/RegisterTrialV2", RequestNamespace = "http://www.xheo.com/licensing/v3_0", ResponseNamespace = "http://www.xheo.com/licensing/v3_0", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string RegisterTrialV2(string email)
        {
            object[] results = this.Invoke("RegisterTrialV2", new object[] {
                        email});
            return ((string)(results[0]));
        }

        /// <remarks/>
        public System.IAsyncResult BeginRegisterTrialV2(string email, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("RegisterTrialV2", new object[] {
                        email}, callback, asyncState);
        }

        /// <remarks/>
        public string EndRegisterTrialV2(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        public void RegisterTrialV2Async(string email)
        {
            this.RegisterTrialV2Async(email, null);
        }

        /// <remarks/>
        public void RegisterTrialV2Async(string email, object userState)
        {
            if ((this.RegisterTrialV2OperationCompleted == null))
            {
                this.RegisterTrialV2OperationCompleted = new System.Threading.SendOrPostCallback(this.OnRegisterTrialV2OperationCompleted);
            }
            this.InvokeAsync("RegisterTrialV2", new object[] {
                        email}, this.RegisterTrialV2OperationCompleted, userState);
        }

        private void OnRegisterTrialV2OperationCompleted(object arg)
        {
            if ((this.RegisterTrialV2Completed != null))
            {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.RegisterTrialV2Completed(this, new RegisterTrialV2CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.6.1055.0")]
    public delegate void RegisterTrialV2CompletedEventHandler(object sender, RegisterTrialV2CompletedEventArgs e);

    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "4.6.1055.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class RegisterTrialV2CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {

        private object[] results;

        internal RegisterTrialV2CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) :
                base(exception, cancelled, userState)
        {
            this.results = results;
        }
