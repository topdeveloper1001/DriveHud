...
namespace DriveHUD.Application.Licensing.GGNetwork
{
    ...
    /// </summary>
    internal interface IGGNLicenseService : IGGNLicenseBaseService
    {
        /// <summary>
        ...
        /// </summary>
        IEnumerable<IGGNLicenseInfo> LicenseInfos { get; }     
        ...
        GGNLicenseType? GetTypeFromSerial(string serial);
    }
}