...
namespace DriveHUD.Application.ReportsLayout
{
    public abstract class ReportLayoutCreator
    {
        ...
        private Tuple<string, string, ColumnType>[] defaultColumns = new Tuple<string, string, ColumnType>[]
        {
            ...
            new Tuple<string, string, ColumnType>("Reports_Column_3Bet_Straddle", nameof(Indicators.ThreeBetInStraddle), ColumnType.Percentile),
            ...
            new Tuple<string, string, ColumnType>("Reports_Column_CheckFoldFlop3BetOop", nameof(Indicators.CheckFoldFlop3BetOop), ColumnType.Percentile),
            new Tuple<string, string, ColumnType>("Reports_Column_CheckFoldFlopPfrOop", nameof(Indicators.CheckFoldFlopPfrOop), ColumnType.Percentile),
            ...
            new Tuple<string, string, ColumnType>("Reports_Column_CheckRaiseFlopAsPFRInSRP", nameof(Indicators.CheckRaiseFlopAsPFRInSRP), ColumnType.Percentile),
            new Tuple<string, string, ColumnType>("Reports_Column_CheckRaiseFlopAsPFRIn3BetPot", nameof(Indicators.CheckRaiseFlopAsPFRIn3BetPot), ColumnType.Percentile),
            ...
            new Tuple<string, string, ColumnType>("Reports_Column_CheckInStraddle", nameof(Indicators.CheckInStraddle), ColumnType.Percentile),
            ...
            new Tuple<string, string, ColumnType>("Reports_Column_FoldInStraddle", nameof(Indicators.FoldInStraddle), ColumnType.Percentile),
            ...
            new Tuple<string, string, ColumnType>("Reports_Column_OpenLimpCO", nameof(Indicators.OpenLimpCO), ColumnType.Percentile),
            new Tuple<string, string, ColumnType>("Reports_Column_OpenLimpBTN", nameof(Indicators.OpenLimpBTN), ColumnType.Percentile),
            new Tuple<string, string, ColumnType>("Reports_Column_OpenLimpSB", nameof(Indicators.OpenLimpSB), ColumnType.Percentile),
            ...
            new Tuple<string, string, ColumnType>("Reports_Column_SkipFlopCBetInSRPandCheckFoldFlopOOP", nameof(Indicators.SkipFlopCBetInSRPandCheckFoldFlopOOP), ColumnType.Percentile),
            ...
            new Tuple<string, string, ColumnType>("Reports_Column_TurnCBet", nameof(Indicators.TurnCBet), ColumnType.Percentile),
            ...
            new Tuple<string, string, ColumnType>("Reports_Column_WTSDInStraddle", nameof(Indicators.WTSDInStraddle), ColumnType.Percentile),
