...
namespace DriveHUD.Application.MigrationService.Migrations
{
    ...
    //                            {
    //                                var hudLayoutInfo = new HudLayoutInfo { IsDefault = false, Name = name, TableType = tableType.Value };
    //                                hudLayoutInfo.HudBumperStickerTypes =
    //                                    hudSavedLayout.HudBumperStickerTypes.Select(c => c.Clone()).ToList();
    //                                hudLayoutInfo.HudPlayerTypes =
    //                                    hudSavedLayout.HudPlayerTypes.Select(c => c.Clone()).ToList();
    //                                hudLayoutInfo.HudPositions = hudSavedLayout.HudPositions.Select(p => p.Clone()).ToList();
    //                                hudLayoutInfo.HudStats = hudSavedLayout.HudStats.Select(s => s.Clone()).ToList();
