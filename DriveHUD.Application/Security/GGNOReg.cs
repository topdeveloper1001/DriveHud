//-----------------------------------------------------------------------
// <copyright file="GGNOReg.cs" company="Ace Poker Solutions">
...
{
    internal class GGNOReg : IGGNLicenseManager
    {
        private readonly GGNORegistration.GGNOReg licenseManager = new GGNORegistration.GGNOReg();
