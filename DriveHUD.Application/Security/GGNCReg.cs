//-----------------------------------------------------------------------
// <copyright file="GGNCReg.cs" company="Ace Poker Solutions">
...
{
    internal class GGNCReg : IGGNLicenseManager
    {
        private readonly GGNCRegistration.GGNCReg licenseManager = new GGNCRegistration.GGNCReg();
