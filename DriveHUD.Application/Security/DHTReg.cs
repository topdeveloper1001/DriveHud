//-----------------------------------------------------------------------
// <copyright file="DHTReg.cs" company="Ace Poker Solutions">
...
namespace DriveHUD.Application.Security
{
    ...
    internal class DHTReg : ILicenseManager
    {
        ...
        {
            var license = SecureLicenseManager.Validate(this, typeof(DHTReg), requestInfo);
            return license;
        }
    }
}