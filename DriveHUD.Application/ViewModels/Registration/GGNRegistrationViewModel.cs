//-----------------------------------------------------------------------
// <copyright file="GGNRegistrationViewModel.cs" company="Ace Poker Solutions">
...
{
    public class GGNRegistrationViewModel : ViewModelBase, INotification, IInteractionRequestAware
    {
        private IGGNLicenseService licenseService;

        private RegistrationState state;

        private string serverUrl = string.Empty;
        private GGNDeployLXLicensingServer server;

        public InteractionRequest<INotification> NotificationRequest { get; private set; }

        public GGNRegistrationViewModel(bool showRegister)
        {
            server = new GGNDeployLXLicensingServer();
            server.CookieContainer = new CookieContainer();

            licenseService = ServiceLocator.Current.GetInstance<IGGNLicenseBaseService>() as IGGNLicenseService;

            NotificationRequest = new InteractionRequest<INotification>();

            title = CommonResourceManager.Instance.GetResourceString("Common_GGNRegistrationView_Title");
        ...
        {
            licenses = new ObservableCollection<LicenseInfoViewModel>(licenseService.LicenseInfos.Where(x => x.IsRegistered && !x.IsTrial)
                .Select(x => new LicenseInfoViewModel(x)));
        ...
        private void InitializeGreeting()
        {
            ...
            TextMessage = CommonResourceManager.Instance.GetResourceString("Common_GGNRegistrationView_GreetingText");
        ...
        private void InitializeTrialExpired()
        {
            ...
            TextMessage = CommonResourceManager.Instance.GetResourceString("Common_GGNRegistrationView_TrialExpiredText");
        ...
        private void InitializeRegister(bool calledFromMain)
        {
            ...
            TextMessage = CommonResourceManager.Instance.GetResourceString("Common_GGNRegistrationView_RegisterText");
        ...
        private bool Register(string serial, string email)
        {
            ...
            catch (LicenseExpiredException)
            {
                ...
                if (licenseType == GGNLicenseType.GGNTrial)
                {
                    InitializeMessage("Common_GGNRegistrationView_TrialExpiredText");
                }
                else
                {
            ...
            this.NotificationRequest.Raise(
                 ...
                 {
                     Content = "Thank you. GG Catcher has been successfully registered!",
                     Title = Title,
                 },
                 n => { });
