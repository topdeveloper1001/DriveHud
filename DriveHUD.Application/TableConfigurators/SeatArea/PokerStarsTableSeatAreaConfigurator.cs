...
namespace DriveHUD.Application.TableConfigurators.SeatArea
{
    internal class PokerStarsTableSeatAreaConfigurator : ITableSeatAreaConfigurator
    {
        ...
        private IEnumerable<ITableSeatArea> Get6MaxList()
        {
            return new List<ITableSeatArea>()
            {
                new TableSeatArea(1, 235.5, 239.833, 49, 550, "M306.48871,17.25673 L302.48871,249.25703 163.48888,249.25703 78.488976,149.2569 186.48885,18.256732 z"),
                new TableSeatArea(2, 213.5, 233.833, 288, 554, "M289.04489,-1.7493764 L290.90316,256.61151 159.895,257.85363 79.060182,129.9153 159.895,-2.9914961 z"),
                new TableSeatArea(3, 108.5, 478.833, 395, 160, "M306.48669,74.01589 L394.48704,208.1657 -64.335173,203.19718 16.069067,75.050585 z"),
                new TableSeatArea(4, 209.5, 219.833, 290, 18, "M205.84095,-1.2508677 L287.33401,129.37623 201.17439,259.59177 68.507274,259.59219 69.840278,-0.42279462 z" ),
                new TableSeatArea(5, 238.833, 229.167, 50, 10, "M190.00019,18.256731 L298.00038,149.7569 216.58357,251.25703 76.99998,251.25703 78.999981,18.256731 z"),
                new TableSeatArea(6, 137.5, 527.5, 45, 134, "M107.5,1 L206.5,131 471,130.5 571.5,-0.5 z"),
           };
        }
