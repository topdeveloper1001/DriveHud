        ...
        public RDPokerPositionProvider()
        {
            Positions = new Dictionary<int, int[,]>
            {
                ...
                },              
                {
                    ...
                    new int[,]
                    {
                        { 237, 813 }, { 8, 651 }, { 8, 343 }, { 237, 165 }, { 449, 343 }, { 449, 651 }
                    }
                },
                {
                    8,
                    new int[,]
                    {
                        { 237, 813 }, { 8, 655 }, { 8, 478 }, { 8, 301 }, { 237, 165 },  { 449, 301 }, { 449, 478 }, { 449, 655 }
                    }
                },
                {
                    9,
                    new int[,]
                    {
                        { 237, 813 }, { 8, 655 }, { 8, 478 }, { 8, 301 }, { 187, 165 }, { 287, 165 },  { 449, 301 }, { 449, 478 }, { 449, 655 }
                    }
                }
            };
